 ...
 * 
 */
public class VrfyProcessor extends AbstractSmtpProcessor {

	@Override
	protected void doProcess(SmtpSession session, TcpTransport trans,
			StringTokenizer st) throws SmtpException {
		// Informs the client that this command is not implemented.
		throw new SmtpException(SmtpException.VRFY_NOT_SUPPORTED);
	}
