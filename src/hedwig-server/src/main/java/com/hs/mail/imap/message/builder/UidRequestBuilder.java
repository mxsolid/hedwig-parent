 ...
 *
 */
public class UidRequestBuilder extends ImapRequestBuilder {
	...
	public ImapRequest createRequest(String tag, String command,
		...
		AbstractUidRequestBuilder builder = (AbstractUidRequestBuilder) ImapRequestFactory
				.lookup(tag, token.value);
		return builder.createRequest(tag, token.value, message, true);
	}
